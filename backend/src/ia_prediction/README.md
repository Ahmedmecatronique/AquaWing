...
```bash
pip install -r backend/src/ia_prediction/requirements.txt
cp backend/src/ia_prediction/.env.example backend/src/ia_prediction/.env   # optionnel
```

## Téléchargement automatique des datasets

```bash
python backend/src/ia_prediction/training/download_dataset.py
```
