...
DATA_DIR = os.getenv("DATA_DIR", os.path.join(BASE_DIR, "ia_prediction", "training", "data"))
SEQUENCES_PATH = os.getenv(
    "SEQUENCES_PATH",
    os.path.join(BASE_DIR, "ia_prediction", "training", "data", "processed", "sequences.npy"),
)
LABELS_PATH = os.getenv(
    "LABELS_PATH",
    os.path.join(BASE_DIR, "ia_prediction", "training", "data", "processed", "labels.npy"),
)
MODEL_SAVE_PATH = os.getenv(
    "MODEL_SAVE_PATH",
    os.path.join(BASE_DIR, "ia_prediction", "models", "lstm_predictor.pt"),
)
