...
window.addEventListener('load', () => {
    ...
    function setActiveNav(activeEl) {
        ...
        if (activeEl === navDashboard) {
            ...
            // Show missions panel (iframe pleine largeur — comme Systems, sans .main-content à côté)
            if (missionsPanel) {
            ...
            const dashboardCamsM = document.querySelector('.dashboard-cams');
            const camsAreaM = document.querySelector('.cams-area');
            const opticalCamerasViewM = document.getElementById('optical-cameras-view');
            if (dashboardCamsM) dashboardCamsM.style.display = 'none';
